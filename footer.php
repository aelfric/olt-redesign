  ...
  <nav class="flex flex-top centered-container text-display">
    ...
    <ul class="footer-column">
      <li>
        ...
        <a class="text-white" href="mailto:info@oldlibrarytheatre.net">info@oldlibrarytheatre.net</a>
      </li>
      <li>
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="height: 1em; fill: var(--olt-purple); margin-right: 1em;">
        ...
        <a href="geo:40.933300,-74.119610">10-10 20th Street (at the corner of Kipp Street)<br />
          Fair Lawn, NJ 07410</a>
      <li>
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 405.333 405.333" style="height: 1em; fill: var(--olt-purple); margin-right: 1em;" xml:space="preserve">
       ...
       c0,205.845,167.488,373.333,373.333,373.333c17.643,0,32-14.357,32-32V298.88C405.333,281.237,390.976,266.88,373.333,266.88z" />
        ...
        <a href="tel:973.OLT.4420">973.OLT.4420</a>
      </li>
      <li>
        <span class="circle bg-purple">
          <a href="<?= get_theme_mod('olt_facebook_link') ?>">
            <svg id="Bold" enable-background="new 0 0 24 24" style="fill: white;" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="m15.997 3.985h2.191v-3.816c-.378-.052-1.678-.169-3.192-.169-3.159 0-5.323 1.987-5.323 5.639v3.361h-3.486v4.266h3.486v10.734h4.274v-10.733h3.345l.531-4.266h-3.877v-2.939c.001-1.233.333-2.077 2.051-2.077z" />
            </svg>
          </a>
        </span>
        <span class="circle bg-purple">
        <a href="<?= get_theme_mod('olt_instagram_link') ?>">
          <svg viewBox="0 0 511 511.9" style="fill: white;" xmlns="http://www.w3.org/2000/svg">
        ...
        <span class="circle bg-purple">
        <a href="<?= get_theme_mod('olt_twitter_link') ?>">
          <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512; fill: white;" xml:space="preserve">
