...
class OltSiteOptions
{
    ...
    public function olt_site_settings_section($wp_customize)
    {
        ...
        $wp_customize->add_control(new WP_Customize_Control($wp_customize, 'olt_settings_friend_text_control', 
        array(
        ...
        $wp_customize->add_control(new WP_Customize_Control($wp_customize, 'olt_settings_donate_text_control', 
        array(
        ...
        $wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'olt_settings_friend_image', 
        array(
        ...
        $wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'olt_settings_footer_image', 
        array(
            'label' => 'Footer Image',
            'section' => $this->SECTION,
            'height' => 510,
